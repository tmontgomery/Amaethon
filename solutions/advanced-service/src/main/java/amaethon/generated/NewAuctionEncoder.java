...
public class NewAuctionEncoder
{
    ...
    public NewAuctionEncoder reserveOrPrice(final long value)
    {
    ...
    public NewAuctionEncoder quantity(final int value)
    {
        CodecUtil.int32Put(buffer, offset + 20, value, java.nio.ByteOrder.LITTLE_ENDIAN);
        return this;
    }
    public NewAuctionEncoder auctionType(final AuctionType value)
    {
        CodecUtil.int8Put(buffer, offset + 24, value.value());
        return this;
    }
