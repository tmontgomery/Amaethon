...
public class BidEncoder
{
    ...
    private final BidEncoder parentMessage = this;
    ...
    public BidEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
        this.buffer = buffer;
        this.offset = offset;
    ...
    public BidEncoder auctionId(final int value)
    {
    ...
    public BidEncoder bidderId(final long value)
    {
    ...
    public BidEncoder value(final long value)
    {
